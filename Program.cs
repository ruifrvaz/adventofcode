...
namespace AdventOfCode
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
            Console.WriteLine($"The answer to Day 2 part 2 puzzle is: {answerDay2Part1.Result}.");
            Console.WriteLine($"The answer to Day 2 part 2 puzzle is: {answerDay2Part2.Result}.");
            Console.WriteLine("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
            Console.WriteLine($"The answer to Day 3 part 2 puzzle is: {answerDay3Part1.Result}.");
